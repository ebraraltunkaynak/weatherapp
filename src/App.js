...
function App() {
  ...
  const handleFetch = () => {
    fetch(
      `http://api.weatherapi.com/v1/forecast.json?key=04441220403&d128b75145324fdc9d22q=${place}&days=1&aqi=no&alerts=no`
    )
    ...
    >
      ...
      <div className="weather-container">
        <div className="top-part">
          <h1>{placeInfo.calcilus?.current}° C</h1>
          <div className="condition-high-low">
            <h1>{placeInfo.condition}</h1>
            <h1>{placeInfo.calcilus?.high}° C</h1>
            <h1>{placeInfo.calcilus?.low}° C</h1>
          </div>
        </div>
        <h2>
